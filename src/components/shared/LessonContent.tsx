              ...
              <ReactMarkdown
                ...
                components={{
                    pre: ({node, ...props}) => {
                        ...
                        // This logic handles code blocks specifically.
                        ...
                        // Fallback for other pre tags if any
                    ...
                    code({node, inline, className, children, ...props}) {
                        ...
                        // Block code is handled by the `pre` component above. This prevents double rendering.
                        return null;
                    },
                }}
              >
