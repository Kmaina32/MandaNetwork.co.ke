...
import { PITCH_DECK, FRAMEWORK, API, B2B_STRATEGY, SEO_STRATEGY, VISUAL_FRAMEWORK, PORTFOLIO_ROADMAP, TELEGRAM_SETUP, TWITTER_SETUP } from '@/lib/document-templates';
import { ScrollArea } from '@/components/ui/scroll-area';
import { format } from 'date-fns';

const ALL_DOC_TYPES = ['PITCH_DECK', 'FRAMEWORK', 'API', 'B2B_STRATEGY', 'SEO_STRATEGY', 'VISUAL_FRAMEWORK', 'PORTFOLIO_ROADMAP', 'TELEGRAM_SETUP', 'TWITTER_SETUP'] as const;
